---
layout: post
title:  "linux安装和配置redis"
desc: "linux安装和配置redis"
keywords: "redis的安装配置,linux,kinglyjn,张庆力"
date: 2016-12-12
categories: [Linux]
tags: [Linux]
icon: fa-bookmark-o
...
4. 后台启动：./redis-server &   
5. 启动时指定配置文件：./redis-server ./redis.conf
6. 检测6379端口是否在监听：netstat -lntp 
7. 使用`redis-cli`客户端检测连接是否正常：./redis-cli
8. 客户端停止：redis-cli shutdown
9. 因为Redis可以妥善处理SIGTERM信号，所以直接kill -9 PID也是可以的
<br><br>
